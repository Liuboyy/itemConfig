...
export function getDomesticPlatformProfitInfo(params = {}) {
    ...
    if (data.is_excel) {
        ...
        window.open('/financereport/Finance_report/getInternalProfit' + str, '_self');
        ...
        return http.getAjax('/financereport/Finance_report/getInternalProfit', data);
    }
}
