...
export function getArrearsCountReportInfo(params = {}) {
    const data = {
        ...CONFIG.ajaxData,
        ...params,
    };
...
export function getPreviewDetailsInfo(params = {}) {
    ...
    if (data.isExcel) {
        ...
        window.open('/orderlack/Order_lack/getLackReportDetail' + str, '_self');
        return new Promise((resolve => {
            resolve({
                data: {
                    status: 2
        ...
        return http.getAjax('/orderlack/Order_lack/getLackReportDetail', data);
    }
}