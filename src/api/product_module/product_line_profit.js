...
export function getProductLineCountInfo(params = {}) {
    ...
    if (data.is_excel) {
        ...
        window.open('/skureport/Sku_report/getGrossProfitData' + str, '_self');
        ...
        return http.getAjax('/skureport/Sku_report/getGrossProfitData', data);
    }
}
