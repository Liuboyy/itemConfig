...
export function getFbaInventoryControlMeterInfo(params = {}) {
    ...
    if (data.is_excel) {
        ...
        window.open('/monitor/Seller_sku/getSkuMeteringList' + str, '_self');
        ...
        return http.getAjax('/monitor/Seller_sku/getSkuMeteringList', data);
    }
}
...
export function getFbaInventoryControlAmountInfo(params = {}) {
    ...
    if (data.is_excel) {
        ...
        window.open('/monitor/Seller_sku/getSkuList' + str, '_self');
        return new Promise((resolve => {
            resolve({
                data: {
                    status: 2
        ...
        return http.getAjax('/monitor/Seller_sku/getSkuList', data);
    }
}
