/**
 * Creator: KarYanLam
 * Creation Date: 2019/12/18 21:07
 */
...
//报表
export function getSupplierMoneyBusinessInfo(params = {}) {
    const data = {
        ...CONFIG.ajaxData,
        ...params,
    };
    ...
    if (data.is_excel) {
        ...
        window.open('/supplier/Supplier_business/getSupplierMoney' + str, '_self');
        ...
        return http.getAjax('/supplier/Supplier_business/getSupplierMoney', data);
    }
}
...
export function getAllEditTitleInfo(params = {}) {
    ...
    return http.getAjax('/supplier/Supplier_business/getAllMoneyTitle', data);
}
...
export function getSaveEditTitleInfo(params = {}) {
    ...
    return http.getAjax('/supplier/Supplier_business/saveMoneyTitle', data);
}