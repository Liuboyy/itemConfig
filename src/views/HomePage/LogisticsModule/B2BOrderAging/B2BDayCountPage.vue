                ...
                <ul class="ui-main-module-search clearFix">
                    ...
                    <li>
                        <SearchRequirement label="异常缺货状态">
                            <el-select collapseTags multiple clearable filterable v-filter v-model="queryData.stockStatus" placeholder="请选择" size="small">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['b2b_day_aging']);
                }
                ...
                this.GetB2BOrderAgingDayInfo(obj).then(({ data }) => {
            ...
            handleQueryInfoCallBack(data) {
                ...
                this.tableProps = ['index','paytime','week_day','platform_type','order_sum','push_use_time','logistics_audit_use_time','dispatched_use_time','draw_order_use_time','scan_packag_use_time','scan_warehouse_use_time','freight_use_time','total_use_time'];
        ...
        created() {
            ...
            try{
                if (JSON.stringify(this.b2bOrderAgingDayInfo) === '{}') {
                    this.queryData.paymentTime = [getCountDate(-7), getCountDate(-1)];
                    this.handleQueryInfo();
                } else {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['b2b_day_aging']);
                    this.handleQueryInfoCallBack(this.b2bOrderAgingDayInfo);
