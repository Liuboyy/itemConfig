...
<script>
    ...
    const component_name = 'quality_control_module_sql';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['quality_control_module_sql']);
                }
            ...
            handleQueryInfoCallBack (data) {
                ...
                this.$store.commit('SAVE_QUERY_PARAMS_INFO', {
                    key: 'quality_control_module_sql',
