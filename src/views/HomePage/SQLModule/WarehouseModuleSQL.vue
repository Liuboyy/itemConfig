...
<script>
    ...
    const component_name = 'warehouse_module_sql';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['warehouse_module_sql']);
                }
