<template>
    <div class="ui-main-module-table">
        <el-table ref="myTable" :data="tableData" :height="tableHeight" border stripe highlight-current-row>
            ...
            <el-table-column label="SKU数量" prop="sku_sum" width="70"></el-table-column>
            ...
            <el-table-column label="到货日期<=45天">
                <el-table-column label="数量" prop="xiao_45_qty" width="70"></el-table-column>
                <el-table-column label="比例" prop="xiao_45_rate" width="80"></el-table-column>
            </el-table-column>
            <el-table-column label="45<到货日期<=60天">
                <el-table-column label="数量" prop="between_45_60_qty" width="70"></el-table-column>
                <el-table-column label="比例" prop="between_45_60_rate" width="80"></el-table-column>
            </el-table-column>
            <el-table-column label="到货日期>60天">
                <el-table-column label="数量" prop="da_60_qty" width="70"></el-table-column>
                <el-table-column label="比例" prop="da_60_rate" width="80"></el-table-column>
            </el-table-column>
