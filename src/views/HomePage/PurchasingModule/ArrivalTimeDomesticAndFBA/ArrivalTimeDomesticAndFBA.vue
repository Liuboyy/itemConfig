...
<script>
    ...
    import {
        getArrivalDomesticAndFbaInfo,
        getOptionList,
        getProductLineList
    } from '@/api/purchasing_module/arrival_domestic_fba';
    ...
    const component_name = 'arrival_domestic_fba';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['arrival_domestic_fba']);
                }
                ...
                this.getArrivalDomesticAndFbaInfo(obj).then(({ data }) => {
