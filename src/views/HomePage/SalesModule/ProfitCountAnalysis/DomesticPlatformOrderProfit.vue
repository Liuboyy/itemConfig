...
<script>
    ...
    import {
        getDomesticPlatformProfitInfo,
        getPlatformList,
        getAccountList,
        getConfirmModifyInfo
    } from '@/api/sales_module/domestic_platform_profit'
    ...
    const component_name = 'domestic_platform_profit';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['domestic_platform_profit']);
                }
                ...
                this.getDomesticPlatformProfitInfo(obj).then(({ data }) => {
