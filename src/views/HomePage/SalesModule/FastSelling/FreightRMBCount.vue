    ...
    <div class="ui-main-module">
        ...
        <div class="ui-tabs_box">
            <el-tabs v-model="queryData.query_type" type="card" @tab-click="handleTabClick">
                <el-tab-pane label="运费成本统计" name="1"></el-tab-pane>
...
<script>
    ...
    const component_name = 'freight_rnb_count';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params, isFn, item) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['freight_rnb_count']);
                }
