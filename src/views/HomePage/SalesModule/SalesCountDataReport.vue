...
<script>
    ...
    const component_name = 'sales_data_report';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params = {}, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['sales_data_report']);
                }
                ...
                let obj = {
                    ...
                    platform: this.queryData.platform.length ? this.queryData.platform.join(',') : [],
                ...
                this.GetSalesDataReportInfo(obj).then(({data}) => {
                    if(data.status === 2) {
