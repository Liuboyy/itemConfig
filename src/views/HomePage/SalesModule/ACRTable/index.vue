<template>
    <div class="ui-common_table">
        <div class="table_content" v-if="showTable">
            ...
            <TableBody ref="tableBody" :check="isCheck" :width="tableHeadWidth" :height="tableHeight" :preview="preview" :table-props="tableProps" :table-data="tableData" :table-key="tableKey" :table-width="tableThWidths" @checked="handleCheckRow" @preview="handlePreview">
