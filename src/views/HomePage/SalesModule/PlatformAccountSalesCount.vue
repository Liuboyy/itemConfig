    ...
    <div class="ui-main-module">
        ...
        <div class="ui-tabs_box">
            <el-tabs v-model="queryData.query_type" type="card" @tab-click="handleTabClick">
                ...
                <el-tab-pane label="订单量统计" name="2"></el-tab-pane>
            </el-tabs>
        </div>
...
<script>
    ...
    import {
        getPlatformAccountSalesCountInfo,
    } from '@/api/sales_module/platform_account_sale_count'
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params, isFn, item) {
                ...
                this.getPlatformAccountSalesCountInfo(obj).then(({data}) => {
