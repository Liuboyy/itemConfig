...
<script>
    ...
    import {
        getTreeDataList,
        getWalmartChannelSpreadChart
    } from '@/api/sales_module/wm_channel_spread_chart';
    ...
    const component_name = 'wm_channel_spread_chart';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params, isFn, item, success) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['wm_channel_spread_chart']);
                }
                ...
                this.getWalmartChannelSpreadChart(obj).then(({ data }) => {
                    if (!data.status) {
