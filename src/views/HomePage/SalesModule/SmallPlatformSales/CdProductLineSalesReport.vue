...
<script>
    ...
    } from '@/api/sales_module/cd_product_cost_count'

    // 组件名称，用于keep-alive和权限（要跟路由保持一致）
    const component_name = 'cd_product_cost_count';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params, isFn, item) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['cd_product_cost_count']);
                }
            ...
            handleTableOpen({id}, treeNode, resolve) {
                ...
                getCdProductCostCurveInfo(obj).then(({data}) => {
