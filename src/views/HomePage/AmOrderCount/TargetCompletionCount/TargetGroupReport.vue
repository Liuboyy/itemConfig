                ...
                <ul class="ui-main-module-search clearFix">
                    ...
                    <li>
                        <SearchRequirement label="数据类型">
                            <el-select size="small" v-model="queryData.dataType" @change="handleChangeType">
                                <el-option
                                        v-for="item in optionList.dataTypeList"
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                let obj = {
                    type: this.queryData.dataType,
                    user_number: this.loginInfo.staff_code,
                    date_select: params,
                    group_id: this.queryData.groupName && this.queryData.groupName.join(','),
...
//                obj = Object.assign(obj || {}, params);
                ...
                this.getPerformanceReportInfo(obj).then(({ data}) => {
                    // 导出
                    if (!data.status) {
