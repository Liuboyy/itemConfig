...
<script>
    ...
    const colorList = ['#fc8a8b', '#DCDCDC', '#fad44d', '#77b2fc', '#6FFC7F', '#634121'];
    const colorLine = ['#ff7778', '#DCDCDC', '#ffc700', '#78b3fc', '#6FFC7F', '#634121'];
    let option = {
        color: colorList,
        title: {
            text: '深圳小组',
                ...
                if (chart) {
                    ...
                    if (this.name === 'move_curve') {
                        ...
                        chart.forEach(_v => {
                            ...
                            item[item.length - 1].push(_v.riqi_day);
                        });
