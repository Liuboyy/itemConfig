        ...
        <TemplateDefault :staticNum="120" color="#FFFFFF">
            <div class="ui-content_area clearFix">
                ...
                <div class="ui-content_area--main">
                    <ComEchart :show-line="queryData.showLine" :ref="item.target" v-for="(item, index) in chartData" width="100%" :key="index" :data="item"></ComEchart>
                </div>
            </div>
        </TemplateDefault>
    </div>
...
//                    fulfillment_type: '',
                    ...
                    is_kevin: 'n',
                    paymentTime: [],
                    showLine: ['销售额', '订单量', 'FBA销售额', 'FBM销售额']
                },
                kevinId: '',
