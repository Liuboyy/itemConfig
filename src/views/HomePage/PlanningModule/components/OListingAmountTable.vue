    ...
    <div class="ui-main-module-table">
        <el-table ref="myTable" :data="tableData" :height="tableHeight" border stripe highlight-current-row>
            ...
            <el-table-column label="基本信息">
                ...
                <el-table-column label="加权日均销售成本" prop="poweravg_money" minWidth="120"></el-table-column>
            </el-table-column>
            <el-table-column label="当前库存">
                <el-table-column label="中转仓在途金额" prop="transit_onway_money" minWidth="110"></el-table-column>
                <el-table-column label="中转仓在库金额" prop="transit_onstock_money" minWidth="110"></el-table-column>
                <el-table-column label="海外仓在途金额" prop="overseas_onway_money" minWidth="110"></el-table-column>
                <el-table-column label="海外仓在库金额" prop="overseas_onstock_money" minWidth="110"></el-table-column>
