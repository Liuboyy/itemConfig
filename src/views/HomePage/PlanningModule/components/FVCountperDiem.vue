...
<template>
    <div class="ui-main-module-table">
        <el-table ref="myTable" :data="tableData" :height="tableHeight" border stripe highlight-current-row >
            ...
            <el-table-column v-for="(item, index) in tableKey" :label="item" :key="index + 1" :fixed="false">
                ...
                <el-table-column label="断货影响比列" prop minWidth="110">
                    <el-table-column label="断货listing占比" prop="count_rate" minWidth="110">
                        <template slot-scope="scope">
                            <span>{{scope.row[item] && scope.row[item].count_rate}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="断货销量影响占比" prop="qty_rate" minWidth="70">
                        <template slot-scope="scope">
                            <span>{{scope.row[item] && scope.row[item].qty_rate}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="断货销售金额影响占比" prop="money_rate" minWidth="100">
                        <template slot-scope="scope">
