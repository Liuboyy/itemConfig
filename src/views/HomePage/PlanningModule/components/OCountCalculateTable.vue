    ...
    <div class="ui-main-module-table">
        <el-table ref="myTable" :data="tableData" :height="tableHeight" border stripe highlight-current-row>
            ...
            <el-table-column label="当前库存">
                <el-table-column label="中转仓在途数量" prop="transit_onway_qty" minWidth="105"></el-table-column>
                <el-table-column label="中转仓在库数量" prop="transit_onstock_qty" minWidth="105"></el-table-column>
                <el-table-column label="海外仓在途数量" prop="overseas_onway_qty" minWidth="105"></el-table-column>
                <el-table-column label="海外仓在库数量" prop="overseas_onstock_qty" minWidth="105"></el-table-column>
            ...
            <el-table-column label="海外仓在库预售天数维度" v-if="isShowOnstock">
                <el-table-column label="预售天数90天内 数量和占比" prop="onstock_90_qty" minWidth="110">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.onstock_90_qty}}</div>
                        <div>{{scope.row.onstock_90_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数90-180天 数量和占比" prop="onstock_90_180_qty" minWidth="125">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.onstock_90_180_qty}}</div>
                        <div>{{scope.row.onstock_90_180_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数180-270天 数量和占比" prop="onstock_180_270_qty" minWidth="130">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.onstock_180_270_qty}}</div>
                        <div>{{scope.row.onstock_180_270_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数270-360天 数量和占比" prop="onstock_270_360_qty" minWidth="130">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.onstock_270_360_qty}}</div>
                        <div>{{scope.row.onstock_270_360_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数超360天 数量和占比" prop="onstock_360_qty" minWidth="120">
                    <template slot-scope="scope">
            ...
            <el-table-column label="海外仓在途+在库预售天数维度" v-if="isShowOnway">
                ...
                <el-table-column label="预售天数90-180天 数量和占比" prop="on_way_stock_90_180_qty" minWidth="125">
                    <template slot-scope="scope">
