    ...
    <div class="ui-main-module-table">
        <el-table ref="myTable" :data="tableData" :height="tableHeight" border stripe highlight-current-row>
            ...
            <el-table-column label="销售情况">
                <el-table-column label="近30天销售种类数" prop="30_sale_sum" minWidth="120"></el-table-column>
                <el-table-column label="在库SKU存活率" prop="available_rate" minWidth="130"></el-table-column>
            ...
            <el-table-column label="预计(总库存)可售卖天数维度" v-if="isShowSale">
                ...
                <el-table-column label="预售天数30-60天 种类数和占比" prop="ysxy_60day_zl" minWidth="120">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.ysxy_60day_zl}}</div>
                        <div>{{scope.row.ysxy_60day_zl_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数60-90天 种类数和占比" prop="ysxy_90day_zl" minWidth="120">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.ysxy_90day_zl}}</div>
                        <div>{{scope.row.ysxy_90day_zl_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="可售天数90-180天 种类数和占比" prop="ysxy_180day_zl" minWidth="125">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.ysxy_180day_zl}}</div>
                        <div>{{scope.row.ysxy_180day_zl_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数180-270天 种类数和占比" prop="ysxy_270day_zl" minWidth="130">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.ysxy_270day_zl}}</div>
                        <div>{{scope.row.ysxy_270day_zl_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数270-360天 种类数和占比" prop="ysxy_360day_zl" minWidth="130">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.ysxy_360day_zl}}</div>
                        <div>{{scope.row.ysxy_360day_zl_rate}}</div>
                    </template>
                </el-table-column>
                <el-table-column label="预售天数超360天 种类数和占比" prop="ysdy_360day_zl" minWidth="120">
                    <template slot-scope="scope">
                        <div class="text-color">{{scope.row.ysdy_360day_zl}}</div>
                        <div>{{scope.row.ysdy_360day_zl_rate}}</div>
                    </template>
                </el-table-column>
