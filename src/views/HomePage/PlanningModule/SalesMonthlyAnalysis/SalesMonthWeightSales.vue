...
<script>
    ...
    import {
        getSalesMonthWeightedAmountInfo,
        getSalesMonthWeightedRatioInfo
    } from '@/api/planning_module/sales_month_weighted';
    ...
    const component_name = 'sales_month_weighted';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['sales_month_weighted']);
                }
                ...
                switch (this.queryData.query_type) {
                    case '1':
                        fnName = this.getSalesMonthWeightedAmountInfo;
                        break;
                    case '2':
                        fnName = this.getSalesMonthWeightedRatioInfo;
                        break;
                }
