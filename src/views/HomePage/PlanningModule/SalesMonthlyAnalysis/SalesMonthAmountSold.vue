...
<script>
    ...
    import {
        getSalesMonthSoldAmountInfo,
        getSalesMonthSoldRatioInfo
    } from '@/api/planning_module/sales_month_amount_sold';
    ...
    const component_name = 'sales_month_amount_sold';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['sales_month_amount_sold']);
                }
                ...
                switch (this.queryData.query_type) {
                    case '1':
                        fnName = this.getSalesMonthSoldAmountInfo;
                        break;
                    case '2':
                        fnName = this.getSalesMonthSoldRatioInfo;
                        break;
                }
