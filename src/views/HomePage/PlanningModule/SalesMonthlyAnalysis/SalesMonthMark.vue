...
<script>
    ...
    import {
        getSalesMonthMarkAmountInfo,
        getSalesMonthMarkRatioInfo
    } from '@/api/planning_module/sales_month_mark';
    ...
    const component_name = 'sales_month_mark';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['sales_month_mark']);
                }
                ...
                switch (this.queryData.query_type) {
                    case '1':
                        fnName = this.getSalesMonthMarkAmountInfo;
                        break;
                    case '2':
                        fnName = this.getSalesMonthMarkRatioInfo;
                        break;
                }
