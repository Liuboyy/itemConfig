...
<script>
    ...
    import {
        getSalesMonthFStockInfo,
    } from '@/api/planning_module/sales_month_f_stock';
    ...
    const component_name = 'sales_month_f_stock';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['sales_month_f_stock']);
                }
                ...
                this.getSalesMonthFStockInfo(obj).then(({ data }) => {
