...
import { getSalesMonthMarkNewData } from "@/api/planning_module/product_identification";
...
import { getSingleDate } from "@/services/index";

// 组件名称，用于keep-alive和权限（要跟路由保持一致）
const component_name = "product_identification";
        ...
        handleQueryInfo(params, isFn) {
            ...
            if (isFn) {
                ...
                this.queryData = JSON.parse(
                    this.queryParamsInfo["product_identification"]
                );
            }
            ...
            getSalesMonthMarkNewData(obj).then(({ data }) => {
