...
import { getSalesMonthMarkNewOnStockData } from "@/api/planning_module/product_inthe_amount";
...
const component_name = "product_inthe_amount";
...
export default {
    ...
    methods: {
        ...mapActions(["Fn"]),
        getSalesMonthMarkNewOnStockData,
        ...
        handleQueryInfo(params, isFn) {
            ...
            if (isFn) {
                ...
                this.queryData = JSON.parse(
                    this.queryParamsInfo["product_inthe_amount"]
                );
            }
            ...
            getSalesMonthMarkNewOnStockData(obj).then(({ data }) => {
