...
import { getSalesMonthMarkNewSumData } from "@/api/planning_module/product_available_stock";
...
const component_name = "product_available_stock";
        ...
        handleQueryInfo(params, isFn) {
            ...
            if (isFn) {
                ...
                this.queryData = JSON.parse(
                    this.queryParamsInfo["product_available_stock"]
                );
            }
            ...
            getSalesMonthMarkNewSumData(obj).then(({ data }) => {
