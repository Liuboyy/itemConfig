...
import { getSalesMonthMarkNewWeightData } from "@/api/planning_module/product_weighting_volume";
...
const component_name = "product_weighting_volume";
...
export default {
    ...
    methods: {
        ...mapActions(["Fn"]),
        getSalesMonthMarkNewWeightData,
        ...
        handleQueryInfo(params, isFn) {
            ...
            if (isFn) {
                ...
                this.queryData = JSON.parse(
                    this.queryParamsInfo["product_weighting_volume"]
                );
            }
            ...
            getSalesMonthMarkNewWeightData(obj).then(({ data }) => {
