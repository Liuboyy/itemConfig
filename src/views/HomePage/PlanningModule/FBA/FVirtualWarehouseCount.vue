<template>
    <div  class="ui-main-module">
        ...
        <FVCountAmountTable :tableData="tableData" :showSearch="showSearch" :otherHeight="['el-tabs__header']" v-if="queryData.query_type === '1'"
                           :isShowAge="isCheckAge" :isShowSale="isCheckSales"></FVCountAmountTable>
        <FVCountCalculateTable :tableData="tableData" :showSearch="showSearch" :otherHeight="['el-tabs__header']" v-if="queryData.query_type === '2'"
                              :isShowAge="isCheckAge" :isShowSale="isCheckSales"></FVCountCalculateTable>
        <FVCountSpeciesTable :tableData="tableData" :showSearch="showSearch" :otherHeight="['el-tabs__header']" v-if="queryData.query_type === '3'"
                            :isShowAge="isCheckAge" :isShowSale="isCheckSales"></FVCountSpeciesTable>
...
<script>
    ...
    import {
        getFVirtualAmountCountInfo,
        getAmountTitleList,
        getConfirmAmountTitleList,
        getFVirtualCalculateCountInfo,
        getCalculateTitleList,
        getConfirmCalculateTitleList,
        getFVirtualSpeciesCountInfo,
        getSpeciesTitleList,
        getConfirmSpeciesTitleList,
        geOptionList
    } from '@/api/planning_module/f_virtual_warehouse_count';

    import {
        getPreDateRange,
    } from '@/api/common/date_format'

    import FVCountAmountTable from '../components/FVCountAmountTable.vue'
    import FVCountCalculateTable from '../components/FVCountCalculateTable.vue'
    import FVCountSpeciesTable from '../components/FVCountSpeciesTable.vue'

    // 组件名称，用于keep-alive和权限（要跟路由保持一致）
    const component_name = 'f_virtual_warehouse_count';

    export default {
        name: component_name,
        components: { FVCountAmountTable, FVCountCalculateTable, FVCountSpeciesTable},
        data() {
            return {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['f_virtual_warehouse_count']);
                }
                ...
                let fnName = this.queryData.query_type === '1' ? this.getFVirtualAmountCountInfo : this.queryData.query_type === '2' ?
                    this.getFVirtualCalculateCountInfo : this.getFVirtualSpeciesCountInfo;
