                ...
                <ul class="ui-main-module-search clearFix">
                    ...
                    <li>
                        <SearchRequirement label="INR类别">
                            <el-select size="small" v-model="queryData.inrType" filterable v-filter clearable>
...
<script>
    ...
    import {
        getServiceIndexInrInfo,
        getOptionList,
        getBatchDeleteInfo
    } from '@/api/customer_service_module/service_index_inr';
    ...
    const component_name = 'service_index_inr';
    ...
    export default {
        ...
        computed: {
            ...
            uploadUrl() {
                return `${config.BI_PATH2}/yibai/zhiku/ebay_customer_service/upload_store_file_inr/upload/`;
            },
            upData() {
                return {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['service_index_inr']);
                }
                ...
                let obj = {
                    ...
                    inr_type: this.queryData.inrType,
                ...
                this.getServiceIndexInrInfo(obj).then(({ data }) => {
...
//                            inr_type: this.saveCheckInfo[i].inr_type,
//                        })
//                    }
...
//                })
            ...
            //下载模板
            handleDownLoad() {
                window.open(`${config.BI_PATH2}/yibai/zhiku/ebay_customer_service/upload_store_file_inr/download/`, '_self');
            },
            ...
            handleQueryInfoCallBack(data) {
                ...
                this.$store.commit('SAVE_QUERY_PARAMS_INFO', {
                    key: 'service_index_inr',
                    value: JSON.stringify(this.queryData)
                });

                //渲染数据
                this.tableKey = ['序号', ...data.title];
                this.tableProps = ['index','account_name','account_short_name','listing_site','inr_type','store_metric','statis_date'];
        ...
        created() {
            this.thisVm = this;
            try{
                getOptionList({ module: 'store_inr' }).then(({ data }) => {
                    ...
                    this.optionList.inrTypeList = data.categor_dict.inr_type_list;
