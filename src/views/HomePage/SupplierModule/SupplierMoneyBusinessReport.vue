                ...
                <el-checkbox-group v-model="checkTitle" @change="handleCheckedTitleChange">
                    <div style="display: flex">
                        <el-checkbox v-for="(label, value) in variableTitleList"
                                     :key="value"
                                     :label="value" :disabled="value === 'pay_amt'">{{label}}</el-checkbox>
                    </div>
                    <div style="flex: 1">
...
<script>
    ...
    import {
        getSupplierMoneyBusinessInfo,
        getOptionList,
        getProductLineList,
        getVariableAndTimeList,
        getAllEditTitleInfo,
        getSaveEditTitleInfo
    } from '../../../api/supplier_module/supplier_money_business_report'


    // 组件名称，用于keep-alive和权限（要跟路由保持一致）
    const component_name = 'supplier_money_business_report';
    ...
    export default {
        ...
        methods: {
            ...
            handleResetQueryInfo(){
                ...
                this.queryData.variableType = 'pay_amt';
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['supplier_money_business_report']);
                }
                let reg = /^\d+(\.\d+)?$/;
                ...
                this.getSupplierMoneyBusinessInfo(obj).then(({ data}) => {
            ...
            handleSortChange(data) {
                ...
                this.$store.commit('SAVE_QUERY_PARAMS_INFO', {
                    key: 'supplier_money_business_report',
            ...
            handleCheckAllChange(val) {
                ...
                this.checkTitle = val ? arr : ['pay_amt'];
            },
        ...
        created(){
            ...
            try{
                ...
                getVariableAndTimeList({ type: 3 }).then(({ data }) => {
