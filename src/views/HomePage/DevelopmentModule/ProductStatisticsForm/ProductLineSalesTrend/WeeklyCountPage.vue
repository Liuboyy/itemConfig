        ...
        <transition name="slide-fade">
            <div class="ui-search-area" v-if="showSearch">
                <ul class="ui-main-module-search clearFix">
                    ...
                    <li>
                        <SearchRequirement label="SKU销售周">
                            <el-select
                                    filterable
                                    collapseTags
                                    multiple
                                    ...
                                    size="small"
                                    placeholder="选择周"
                                    v-model="queryData.weeks"
                                    @change="change()">
                                <el-option
                                        v-for="(label, value) in optionList.weeksList"
                                        :key="value"
                                        :value="value"
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo (params = {}, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['product_line_week']);
                }
                ...
                let obj = {
                    ...
                    sale_time: this.queryData.weeks && this.queryData.weeks.length ? this.queryData.weeks.join(',') : this.queryData.salesMonth,
            ...
            handleResetQueryInfo () {
                ...
                this.queryData.salesMonth = this.saveDefaultMonth;
                this.queryData.week = [];
                ...
                this.handleChangeQueryInfo(this.queryData.salesMonth);
            },

            //时间监听
            handleChange(val) {
                this.queryData.weeks = [];
            ...
            handleChangeQueryInfo(date) {
                getDateOptionListInfo({
                    ...
                    this.optionList.weeksList = data.dates;
        ...
        created () {
            ...
            try {
                getCurrentMonth().then((data) => {
                    ...
                    getCurrentDateRange().then((data) => {
                        if (!this.productLineSalesTrendInfo['2'] || JSON.stringify(this.productLineSalesTrendInfo['2']) === '{}') {
                            this.queryData.createTime = [data.start, data.end];
                            this.queryData.inSalesTime = [data.start, data.end];
                            this.queryData.salesMonth = this.saveDefaultMonth;
                            this.handleChangeQueryInfo(this.queryData.salesMonth);
                            ...
                            this.queryData = JSON.parse(this.queryParamsInfo['product_line_week']);
                            this.handleChangeQueryInfo(this.queryData.salesMonth);
                            this.handleQueryInfoCallBack(this.productLineSalesTrendInfo['2']);
                            if (this.comOptions['week_list']) this.optionList = this.comOptions['week_list'];
                        }
                    });
                });
            } catch (e) {
