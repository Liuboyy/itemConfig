                ...
                <ul class="ui-main-module-search clearFix">
                    ...
                    <li>
                        <SearchRequirement label="开发类型">
                            <el-select filterable v-filter size="small" v-model="queryData.devType">
                                <el-option
...
<script>
    ...
    import {
        getBoutiqueRepairDetailsInfo
    } from '../../../../api/design_module/boutique_repair_details'
    // 组件名称，用于keep-alive和权限（要跟路由保持一致）
    const component_name = 'boutique_repair_details';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['boutique_repair_details']);
                }
                ...
                let obj = {
                    ...
                    devp_type: this.queryData.devType,
                    spu: this.queryData.spu,
                };

                obj = Object.assign(obj || {}, params);

                this.getBoutiqueRepairDetailsInfo(obj).then(({ data}) => {
                    // 导出
                    if (!data.status) {
            ...
            handleQueryInfoCallBack(data){
                ...
                this.optionList.devTypeList = data.list.art_task_type_list;
