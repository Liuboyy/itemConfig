...
<script>
    ...
    import {
        getDesignRepairDetailsInfo
    } from '../../../../api/design_module/design_repair_details'
    // 组件名称，用于keep-alive和权限（要跟路由保持一致）
    const component_name = 'design_repair_details';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['design_repair_details']);
                }
                ...
                this.getDesignRepairDetailsInfo(obj).then(({ data}) => {
                    // 导出
                    if (!data.status) {
