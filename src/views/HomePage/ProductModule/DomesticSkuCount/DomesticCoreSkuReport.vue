    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                this.GetCoreDomesticSkuReportInfo(obj).then(({ data }) => {
        ...
        created() {
            ...
            try {
                if (JSON.stringify(this.domesticCoreSkuReportInfo) === '{}') {
                    this.handleQueryInfo();
                } else {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['core_domestic_sku_report']);
                    this.defaultSort = this.queryData.sortOrder;
                    this.handleQueryInfoCallBack(this.domesticCoreSkuReportInfo);
                }
            } catch (e) {
                console.log(e);
            }
