...
<script>
    ...
    const component_name = 'domestic_sku_count';
    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['domestic_sku_report']);
                }
                ...
                this.GetDomesticSkuReportInfo(obj).then(({ data }) => {
            ...
            handleQueryInfoCallBack(data) {
                ...
                this.tableProps = ['index','platform_name','sku','is_clearance','avg_sale', 'sku_sale','sku_unit','cny_sku_unit','sku_price','cny_sku_price','sku_profit','profit_rate'];
                this.tableSort = [false,false,false,false,false, 'custom','custom','custom','custom','custom','custom','custom'];
        ...
        created() {
            ...
            try {
                if (JSON.stringify(this.domesticSkuReportInfo) === '{}') {
                    this.handleQueryInfo();
                } else {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['domestic_sku_report']);
                    this.defaultSort = this.queryData.sortOrder;
                    this.handleQueryInfoCallBack(this.domesticSkuReportInfo);
                }
            } catch (e) {
                console.log(e);
            }
