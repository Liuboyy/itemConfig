    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                this.GetOverseaSkuWeekReportInfo(obj).then(({ data }) => {
        ...
        created() {
            ...
            try {
                if (JSON.stringify(this.overseaSkuWeekReportInfo) === '{}') {
                    this.handleQueryInfo();
                } else {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['oversea_sku_report']);
                    this.defaultSort = this.queryData.sortOrder;
                    this.handleQueryInfoCallBack(this.overseaSkuWeekReportInfo);
                }
            } catch (e) {
                console.log(e);
            }
