    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['more_reject_summary']);
                }
                ...
                this.GetMoreRejectNumSummaryInfo(obj).then(({ data}) => {
                    // 导出
            ...
            handleQueryInfoCallBack(data){
                ...
                this.$store.commit('SAVE_QUERY_PARAMS_INFO', {
                    key: 'more_reject_summary',
                    value: JSON.stringify(this.queryData)
                });

                this.tableKey = data.title;
                this.tableData = data.data;
                this.tableProps = ['devp_user_name','rate','complete_formula'];
        ...
        created(){
            ...
            try{
                getPreDateRange().then((data) => {
                    ...
                    if (JSON.stringify(this.moreRejectSummaryInfo) === '{}') {
                        this.queryData.date = this.saveDefaultDate;
                        this.handleQueryInfo();
                    } else {
                        // 获取保存的查询参数
                        this.queryData = JSON.parse(this.queryParamsInfo['more_reject_summary']);
                        this.handleQueryInfoCallBack(this.moreRejectSummaryInfo);
                    }
                });
            }catch (e) {
                console.log(e);
