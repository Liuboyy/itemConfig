    ...
    export default {
        ...
        methods: {
            ...
            handleQueryInfo(params, isFn) {
                ...
                if (isFn) {
                    // 获取保存的查询参数
                    this.queryData = JSON.parse(this.queryParamsInfo['sample_tqe_report']);
                }
            ...
            handleQueryInfoCallBack(data){
                ...
                if(this.queryData.tabType == '2' || this.queryData.tabType == '3') {//日汇总
                    ...
                    this.tableProps = ['user_name','review_num','reject_num','pass_rate']
                }
        ...
        created(){
            ...
            try{
                getCurrentYear().then((data) => {
                    ...
                    getPreDateRange().then((data) => {
                        if (!this.sampleDevelopmentGroupInfo['tqe'] || JSON.stringify(this.sampleDevelopmentGroupInfo['tqe']) === '{}') {
                            this.queryData.year = this.saveEndYear;
                            this.queryData.startYear = this.saveStartYear;
                            this.queryData.endYear = this.saveEndYear;
                            this.queryData.months = this.saveDefaultMonth;
                            ...
                            // 获取保存的查询参数
                            this.queryData = JSON.parse(this.queryParamsInfo['sample_tqe_report']);
                            this.handleQueryInfoCallBack(this.sampleDevelopmentGroupInfo['tqe']);
                        }
                    });
                });
            }catch (e) {
